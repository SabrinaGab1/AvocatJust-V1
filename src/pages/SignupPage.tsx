...
export default function SignupPage() {
  ...
  const renderStep = () => {
    switch (currentStep) {
      ...
      case 2:
        return <ValidationStep onBack={handleBack} />;
      default:
        return null;
    }
  };
  ...
  return (
    <AnimatedPage>
      <div className="min-h-screen">
        ...
        <div className="relative -mt-16 max-w-4xl mx-auto px-4 pb-12">
                  ...
                  >
                    ...
                    <div className="ml-3">
                      ...
                      <span className="block text-xs text-gray-400 mt-0.5">
                        {index === 0 && 'Choisissez votre formule'}
                        {index === 1 && 'Créez votre compte'}
                        {index === 2 && 'Confirmez votre email'}
                      </span>
                    </div>
                  </div>
                </div>
